    ...
    if(loading){
        ...
        return (
            ...
            <div >
                ...
                <div className="section_heading text-3xl">Courses to get you started</div>
                ...
                {/* section2 */}
                <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent text-richblack-5">
                <div className="section_heading  text-3xl">Also Checkout {catalogPageData?.differentCourses.name} Courses</div>
                    <div className="py-8">
                ...
                {/* section3 */}
                <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent text-richblack-5">
                    <div className="section_heading text-3xl">Most Selling Courses</div>
                    <div className='py-8'>
